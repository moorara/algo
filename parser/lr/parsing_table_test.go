...
func getTestParsingTables() []*ParsingTable {
	...
	pt0.AddACTION(2, "+", &Action{Type: REDUCE, Production: prods[1][2]})
	pt0.AddACTION(2, "*", &Action{Type: SHIFT, State: 7})
	pt0.AddACTION(2, ")", &Action{Type: REDUCE, Production: prods[1][2]})
	pt0.AddACTION(2, grammar.Endmarker, &Action{Type: REDUCE, Production: prods[1][2]})
	pt0.AddACTION(3, "+", &Action{Type: REDUCE, Production: prods[1][4]})
	pt0.AddACTION(3, "*", &Action{Type: REDUCE, Production: prods[1][4]})
	pt0.AddACTION(3, ")", &Action{Type: REDUCE, Production: prods[1][4]})
	pt0.AddACTION(3, grammar.Endmarker, &Action{Type: REDUCE, Production: prods[1][4]})
	pt0.AddACTION(4, "id", &Action{Type: SHIFT, State: 5})
	pt0.AddACTION(4, "(", &Action{Type: SHIFT, State: 4})
	pt0.AddACTION(5, "+", &Action{Type: REDUCE, Production: prods[1][6]})
	pt0.AddACTION(5, "*", &Action{Type: REDUCE, Production: prods[1][6]})
	pt0.AddACTION(5, ")", &Action{Type: REDUCE, Production: prods[1][6]})
	pt0.AddACTION(5, grammar.Endmarker, &Action{Type: REDUCE, Production: prods[1][6]})
	...
	pt0.AddACTION(9, "+", &Action{Type: REDUCE, Production: prods[1][1]})
	pt0.AddACTION(9, "*", &Action{Type: SHIFT, State: 7})
	pt0.AddACTION(9, ")", &Action{Type: REDUCE, Production: prods[1][1]})
	pt0.AddACTION(9, grammar.Endmarker, &Action{Type: REDUCE, Production: prods[1][1]})
	pt0.AddACTION(10, "+", &Action{Type: REDUCE, Production: prods[1][3]})
	pt0.AddACTION(10, "*", &Action{Type: REDUCE, Production: prods[1][3]})
	pt0.AddACTION(10, ")", &Action{Type: REDUCE, Production: prods[1][3]})
	pt0.AddACTION(10, grammar.Endmarker, &Action{Type: REDUCE, Production: prods[1][3]})
	pt0.AddACTION(11, "+", &Action{Type: REDUCE, Production: prods[1][5]})
	pt0.AddACTION(11, "*", &Action{Type: REDUCE, Production: prods[1][5]})
	pt0.AddACTION(11, ")", &Action{Type: REDUCE, Production: prods[1][5]})
	pt0.AddACTION(11, grammar.Endmarker, &Action{Type: REDUCE, Production: prods[1][5]})
