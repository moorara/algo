...
func getRedBlackTests() []orderedSymbolTableTest[string, int] {
	...
	tests[0].expectedDOT = `strict digraph "Red-Black" {
  concentrate=false;
  ...
  1 -> 3 [];
	...
	tests[1].equal = NewRedBlack[string, int](cmpKey, eqVal)
	...
	tests[1].expectedDOT = `strict digraph "Red-Black" {
  concentrate=false;
  node [style=filled, shape=oval];
  ...
  2 -> 4 [];
	...
	tests[2].equal = NewRedBlack[string, int](cmpKey, eqVal)
	tests[2].equal.Put("D", 4)
	tests[2].equal.Put("J", 10)
	tests[2].equal.Put("P", 16)
	...
	tests[2].expectedDOT = `strict digraph "Red-Black" {
  concentrate=false;
  node [style=filled, shape=oval];
  ...
  5 -> 7 [];
	...
	tests[3].equal = NewRedBlack[string, int](cmpKey, eqVal)
	...
	tests[3].expectedDOT = `strict digraph "Red-Black" {
  concentrate=false;
  node [style=filled, shape=oval];
