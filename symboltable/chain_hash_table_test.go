...
func getChainHashTableTests() []symbolTableTest[string, int] {
	...
	tests[0].equals = NewChainHashTable[string, int](hashFunc, eqKey, eqVal, opts)
	...
	tests[1].equals = NewChainHashTable[string, int](hashFunc, eqKey, eqVal, opts)
	...
	tests[2].equals = NewChainHashTable[string, int](hashFunc, eqKey, eqVal, opts)
	...
	tests[3].equals = NewChainHashTable[string, int](hashFunc, eqKey, eqVal, opts)
