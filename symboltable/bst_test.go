...
func getBSTTests() []orderedSymbolTableTest[string, int] {
	...
	tests[0].expectedDOT = `strict digraph "BST" {
  concentrate=false;
  node [shape=oval];
  ...
  1 -> 3 [];
	...
	tests[1].equal = NewBST[string, int](cmpKey, eqVal)
	...
	tests[1].expectedDOT = `strict digraph "BST" {
  concentrate=false;
  node [shape=oval];
  ...
  4 -> 5 [];
	...
	tests[2].equal = NewBST[string, int](cmpKey, eqVal)
	...
	tests[2].expectedDOT = `strict digraph "BST" {
  concentrate=false;
  node [shape=oval];
  ...
  5 -> 7 [];
	...
	tests[3].equal = NewBST[string, int](cmpKey, eqVal)
	...
	tests[3].expectedDOT = `strict digraph "BST" {
  concentrate=false;
  node [shape=oval];
