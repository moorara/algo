...
func getQuadHashTableTests() []symbolTableTest[string, int] {
	...
	tests[0].equals = NewQuadraticHashTable[string, int](hashFunc, eqKey, eqVal, opts)
	...
	tests[1].equals = NewQuadraticHashTable[string, int](hashFunc, eqKey, eqVal, opts)
	...
	tests[2].equals = NewQuadraticHashTable[string, int](hashFunc, eqKey, eqVal, opts)
	...
	tests[3].equals = NewQuadraticHashTable[string, int](hashFunc, eqKey, eqVal, opts)
