...
type FormatList[T Discrete] func(iter.Seq[Range[T]]) string
...
type FormatMap[T Discrete, V any] func(iter.Seq2[Range[T], V]) string

func defaultFormatMap[T Discrete, V any](all iter.Seq2[Range[T], V]) string {
	var b bytes.Buffer
